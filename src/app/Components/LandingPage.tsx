...
//     // If name or email is empty, show an error message or handle it as per your requirement
...
//     // If the email format is invalid, show an error message or handle it as per your requirement
...
//       setShowHeader4(true);
//     }, 7000);
//     const acessTextDelay = setTimeout(() => {
